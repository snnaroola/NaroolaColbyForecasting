...
text(st_geometry(buoys), labels = buoys$id, cex = 0.7, adj = c(1,-0.2))
```
...
If you are wondering about filtering a table, be sure to [check out the wiki on tabular data](https://github.com/BigelowLab/ColbyForecasting/wiki/tables) to get started.
